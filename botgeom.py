...
async def show_commandsconsumbuff(ctx):
    ...
    embed.add_field(name='15', value='Contoh: `bwapres` - Menampilkan list code buff p resis.', inline=False)
    embed.add_field(name='15', value='Contoh: `bwamres` - Menampilkan list code buff m resis.', inline=False)
